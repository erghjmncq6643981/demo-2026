...
class LearningPlanResponseAssemblerTest {
    ...
    void loadsPlanRelationsInBatchesInsteadOfPerUnitQueries() {
        ...
        when(progressMapper.selectBatchIds(any())).thenReturn(List.of(firstProgress, secondProgress));
        ...
        LearningPlanResponseAssembler assembler = new LearningPlanResponseAssembler(
                unitMapper, unitEntryMapper, materialMapper, progressMapper, reviewRecordMapper, new ObjectMapper());
        ...
        verify(progressMapper).selectBatchIds(any());
