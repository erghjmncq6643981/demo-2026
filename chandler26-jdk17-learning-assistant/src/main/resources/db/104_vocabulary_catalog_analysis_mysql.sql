...
ON DUPLICATE KEY UPDATE content = VALUES(content), variables = VALUES(variables), description = VALUES(description),
    example_input = VALUES(example_input), example_output = VALUES(example_output), public_template = VALUES(public_template), enabled = VALUES(enabled), sequence = VALUES(sequence), update_time = CURRENT_TIMESTAMP;
