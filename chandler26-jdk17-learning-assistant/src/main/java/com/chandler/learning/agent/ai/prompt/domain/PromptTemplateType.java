package com.chandler.learning.agent.ai.prompt.domain;
...
public enum PromptTemplateType {
    ...
    SYSTEM(LearningConstants.PromptTemplate.TYPE_SYSTEM, "系统提示词"),
    USER(LearningConstants.PromptTemplate.TYPE_USER, "用户提示词"),
    ANALYSIS(LearningConstants.PromptTemplate.TYPE_ANALYSIS, "分析提示词");
