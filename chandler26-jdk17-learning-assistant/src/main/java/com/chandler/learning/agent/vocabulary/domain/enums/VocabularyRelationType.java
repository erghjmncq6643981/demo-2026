...
public enum VocabularyRelationType {
    ...
    SYNONYM(VocabularyInsightConstants.RELATION_TYPE_SYNONYM, "同义词", true, List.of("synonyms")),
    ANTONYM(VocabularyInsightConstants.RELATION_TYPE_ANTONYM, "反义词", true, List.of("antonyms")),
    WORD_FAMILY(VocabularyInsightConstants.RELATION_TYPE_WORD_FAMILY, "词族", true, List.of("word_family", "wordFamily")),
    TAG_OVERLAP(VocabularyInsightConstants.RELATION_TYPE_TAG_OVERLAP, "标签相似", false,
            List.of("synonyms", "antonyms", "word_family", "wordFamily", "collocations")),
    COLLOCATION(VocabularyInsightConstants.RELATION_TYPE_COLLOCATION, "搭配", false, List.of("collocations"));
