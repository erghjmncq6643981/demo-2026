...
public enum LearningScene {
    ...
    ENGLISH_VOCABULARY(AiChatConstants.SCENE_ENGLISH_VOCABULARY, "英语词汇学习"),
    ENGLISH_ARTICLE(AiChatConstants.SCENE_ENGLISH_ARTICLE, "英语语境精读"),
    ENGLISH_VOCABULARY_PLAN(AiChatConstants.SCENE_ENGLISH_VOCABULARY_PLAN, "英语场景词汇计划"),
    MATH(AiChatConstants.SCENE_MATH, "数学学习"),
    PINYIN(AiChatConstants.SCENE_PINYIN, "汉语拼音学习"),
    WRITING(AiChatConstants.SCENE_WRITING, "写作学习");
