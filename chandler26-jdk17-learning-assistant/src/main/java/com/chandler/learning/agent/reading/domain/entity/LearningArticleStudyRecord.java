package com.chandler.learning.agent.reading.domain.entity;
...
public class LearningArticleStudyRecord extends BaseEntity {
    ...
    public static LearningArticleStudyRecord create(Long userId, Long wordbookId, String selectedTermsJson,
        ...
        record.setLookupCount(ArticleConstants.DEFAULT_LOOKUP_COUNT);
        record.setLastLookupTime(now);
        record.setStudyStatus(ArticleConstants.STATUS_GENERATED);
        record.setCurrentStage(ArticleConstants.STAGE_READING);
        record.setPracticeTotal(CommonConstants.ZERO);
        record.setPracticeCorrect(CommonConstants.ZERO);
        record.setPracticeScore(CommonConstants.ZERO);
    ...
    public void touch(LocalDateTime now) {
        setLookupCount(getLookupCount() == null
                ...
                : getLookupCount() + CommonConstants.SEQUENCE_STEP);
        setLastLookupTime(now);
        setUpdateTime(now);
    }
    ...
    public void moveToStage(String stage, LocalDateTime now) {
        if (!ArticleConstants.STATUS_COMPLETED.equals(getStudyStatus())) {
            setStudyStatus(ArticleConstants.STATUS_IN_PROGRESS);
    ...
    public void completeStudy(int total, int correct, int score, LocalDateTime now) {
        setStudyStatus(ArticleConstants.STATUS_COMPLETED);
        setCurrentStage(ArticleConstants.STAGE_COMPLETED);
