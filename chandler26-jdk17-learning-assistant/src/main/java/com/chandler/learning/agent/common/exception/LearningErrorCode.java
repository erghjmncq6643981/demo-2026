...
AUTH_REQUIRED(HttpStatus.UNAUTHORIZED, "请先登录"),
        ...
        AI_RESPONSE_STRUCTURE_INCOMPLETE(HttpStatus.BAD_GATEWAY, "AI 返回内容结构不完整，请重试或切换模型"),
        ...
        VOCABULARY_SEMANTIC_BUSY(HttpStatus.CONFLICT, "其他词本正在分析新词，请稍后重试未完成词条，已有结果将自动复用"),
