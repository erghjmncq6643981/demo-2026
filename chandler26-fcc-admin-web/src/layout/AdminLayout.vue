...
<template>
  ...
  <div class="w-screen h-screen bg-[#F8FAFD] flex overflow-hidden">
    ...
    <aside
      class="w-56 bg-white border-r border-slate-100 flex flex-col justify-between p-4 shrink-0 z-20 h-full select-none"
    >
      <div>
        <!-- 品牌 LOGO -->
        <div class="flex items-center gap-2.5 mb-5 px-1">
          <div
            class="w-9 h-9 rounded-xl bg-gradient-to-tr from-blue-600 via-indigo-600 to-purple-600 flex items-center justify-center text-white text-lg shadow-md shadow-indigo-500/20 shrink-0"
          >
            📦
          </div>
          <div>
        ...
        <div class="space-y-4">
          <div>
            <div class="text-[11px] font-bold text-slate-400 uppercase tracking-wider px-2 mb-2">
              话务与监控
            </div>
            <div class="space-y-1 font-bold">
              ...
              <button
                ...
                :class="
                  activeTab === 'routes' || activeTab === 'callback'
              ...
              >
                <div class="flex items-center gap-2.5">
                  <svg
                    ...
                    :class="
                      activeTab === 'routes' || activeTab === 'callback' ? 'text-brand-500' : 'text-slate-400'
                    "
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                ...
                <span
                  ...
                  :class="
                    activeTab === 'routes' || activeTab === 'callback' ? 'bg-brand-500' : 'bg-transparent'
                  "
                ></span>
              </button>
              ...
              >
                <div class="flex items-center gap-2.5">
                  <svg
                    class="w-4 h-4 shrink-0"
                    :class="activeTab === 'groups' ? 'text-brand-500' : 'text-slate-400'"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span
                  class="w-1.5 h-1.5 rounded-full shrink-0"
                  :class="activeTab === 'groups' ? 'bg-brand-500' : 'bg-transparent'"
                ></span>
              </button>
              ...
              >
                <div class="flex items-center gap-2.5">
                  <svg
                    class="w-4 h-4 shrink-0"
                    :class="activeTab === 'orgreport' ? 'text-brand-500' : 'text-slate-400'"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span
                  class="w-1.5 h-1.5 rounded-full shrink-0"
                  :class="activeTab === 'orgreport' ? 'bg-brand-500' : 'bg-transparent'"
                ></span>
              </button>
              ...
              >
                <div class="flex items-center gap-2.5">
                  <svg
                    class="w-4 h-4 shrink-0"
                    :class="activeTab === 'flows' ? 'text-brand-500' : 'text-slate-400'"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span
                  class="w-1.5 h-1.5 rounded-full shrink-0"
                  :class="activeTab === 'flows' ? 'bg-brand-500' : 'bg-transparent'"
                ></span>
              </button>
              ...
              >
                <div class="flex items-center gap-2.5">
                  <svg
                    class="w-4 h-4 shrink-0"
                    :class="activeTab === 'running' ? 'text-brand-500' : 'text-slate-400'"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span
                  class="w-1.5 h-1.5 rounded-full shrink-0"
                  :class="activeTab === 'running' ? 'bg-brand-500' : 'bg-transparent'"
                ></span>
              </button>
            </div>
          </div>
            ...
            <div class="space-y-1 font-bold">
              ...
              >
                <div class="flex items-center gap-2.5">
                  <svg
                    class="w-4 h-4 shrink-0"
                    :class="activeTab === 'extensions' ? 'text-brand-500' : 'text-slate-400'"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span
                  class="w-1.5 h-1.5 rounded-full shrink-0"
                  :class="activeTab === 'extensions' ? 'bg-brand-500' : 'bg-transparent'"
                ></span>
              </button>
              ...
              >
                <div class="flex items-center gap-2.5">
                  <svg
                    class="w-4 h-4 shrink-0"
                    :class="activeTab === 'sysvars' ? 'text-brand-500' : 'text-slate-400'"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span
                  class="w-1.5 h-1.5 rounded-full shrink-0"
                  :class="activeTab === 'sysvars' ? 'bg-brand-500' : 'bg-transparent'"
                ></span>
              </button>
              ...
              >
                <div class="flex items-center gap-2.5">
                  <svg
                    class="w-4 h-4 shrink-0"
                    :class="activeTab === 'clients' ? 'text-brand-500' : 'text-slate-400'"
                    fill="none"
                    stroke="currentColor"
                    viewBox="0 0 24 24"
                  >
                ...
                <span
                  class="w-1.5 h-1.5 rounded-full shrink-0"
                  :class="activeTab === 'clients' ? 'bg-brand-500' : 'bg-transparent'"
                ></span>
              </button>
            </div>
          </div>
        ...
        <div class="flex items-center gap-4">
          ...
          >
            <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              <rect x="4" y="3" width="16" height="7" rx="2" stroke-width="1.5" />
              <rect x="4" y="14" width="16" height="7" rx="2" stroke-width="1.5" />
              <path d="M8 6h.01M8 17h.01M12 10v4" stroke-width="2" stroke-linecap="round" />
            </svg>
          </button>
          ...
          <button
            ...
            :title="
              pendingCallbackCount > 0 ? `${pendingCallbackCount} 条未接待回拨待处理` : '暂无待处理通知'
            "
          >
    ...
    >
      <div class="bg-white rounded-3xl p-6 max-w-xl w-full shadow-popover border border-slate-100 space-y-4">
        ...
        <div v-if="probing" class="bg-slate-50 border border-slate-200 p-4 text-sm text-slate-600">
          正在通过管理端查询 Sidecar 与 FreeSWITCH 实时状态...
        </div>
        <div v-else-if="probeError" class="bg-rose-50 border border-rose-200 p-4 text-sm text-rose-700">
          {{ probeError }}
        </div>
        <dl
        ...
        >
          ...
          <dd class="font-mono text-xs text-slate-900 break-all">{{ probeResult.nodeId || '-' }}</dd>
          <dt class="text-slate-500">节点状态</dt>
          <dd class="font-semibold text-slate-900">{{ probeResult.nodeState || '-' }}</dd>
          <dt class="text-slate-500">FreeSWITCH</dt>
          <dd :class="probeResult.freeSwitchAlive ? 'text-emerald-700' : 'text-rose-700'">
            {{ probeResult.freeSwitchAlive ? '可用' : '不可用' }}
          </dd>
          <dt class="text-slate-500">PostgreSQL</dt>
          <dd :class="probeResult.databaseConnected ? 'text-emerald-700' : 'text-rose-700'">
            {{ probeResult.databaseConnected ? '可用' : '不可用' }}
          </dd>
          <dt class="text-slate-500">活跃通道</dt>
          <dd class="font-mono text-slate-900">
            {{ probeResult.activeChannels ?? '-' }} / {{ probeResult.maxChannels ?? '-' }}
          </dd>
