...
import com.chandler.motivation.security.JwtAuthenticationFilter;
...
@EnableConfigurationProperties(MotivationSecurityProperties.class)
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        return http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        .requestMatchers("/api/health", "/api/v1/health", "/api/v1/auth/register", "/api/v1/auth/login").permitAll()
