...
public class P0P1CoreFeaturesTest {
  ...
  void testCdrTracePipeline() {
    ...
    var loginSession = org.mockito.Mockito.mock(
      cn.dev33.satoken.session.SaSession.class
    );
    org.mockito.Mockito.when(loginSession.get("tenantId")).thenReturn(0L);
    try (
      var authentication = org.mockito.Mockito.mockStatic(
        cn.dev33.satoken.stp.StpUtil.class
      );
    ) {
      authentication
        .when(cn.dev33.satoken.stp.StpUtil::getSession)
  ...
  void testFlowDefinitionAndSimulation() {
    var fixture =
      com.chandler.fcc.admin.infrastructure.persistence.entity.FlowDefinitionEntity.builder()
        .id(IdUtil.nextId())
        .tenantId(0L)
    ...
    try (
      var auth = org.mockito.Mockito.mockStatic(
        cn.dev33.satoken.stp.StpUtil.class
      );
    ) {
