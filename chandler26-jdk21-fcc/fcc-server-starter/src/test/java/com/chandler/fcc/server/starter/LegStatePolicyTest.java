...
class LegStatePolicyTest {
    ...
    @Test void rejectsNonCanonicalCallIds() {
        assertEquals(123L, com.chandler.fcc.server.infrastructure.persistence.service.CallPersistenceService.parseNumericId("123"));
        for (String invalid : new String[]{"call-123", "", "0", "-1", "0123", "abc", "9999999999999999999"}) {
            assertThrows(IllegalArgumentException.class, () -> com.chandler.fcc.server.infrastructure.persistence.service.CallPersistenceService.parseNumericId(invalid));
        }
        assertThrows(IllegalArgumentException.class, () -> com.chandler.fcc.server.infrastructure.persistence.service.CallPersistenceService.parseNumericId(null));
    }
